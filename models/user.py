...
class User(UserMixin, db.Model):
    ...
    files = db.relationship("StoredFile", foreign_keys="StoredFile.owner_id", backref="owner", lazy=True)
    locked_files = db.relationship("StoredFile", foreign_keys="StoredFile.lock_owner_id", lazy=True)
